...
int main()
{
	...
	Model_weights_socket();
	start_application();

	/* receive and process packets */
	while (1) {
		xemacif_input(echo_netif);  // The function of the application loop is to receive packets constantly, then pass them on to lwIP.
		//xil_printf("deneme %d\n");
		transfer_data();
